...
_Startup:                                       
                ...
                JSR   initPORTS                                
                JSR   initAD                       ; initialize ATD convertor                                                                              
...
NO_REV_BUMP     LDAA  SENS_D                    ; if SENS_D equals 1 
...
NO_RT_INTXN     LDAA  SENS_B                    ; if SENS_B equals 1
                BEQ   NO_LT_INTXN               
                LDAA  SENS_A                    ; If f equals 1 
                BEQ   LT_TURN                   ; go forward
                LDAA  NEXT_D                    
                PSHA                            ; push stack
                LDAA  PRI_PTH_INT                
                STAA  NEXT_D                     
                BRA   NO_SHFT_LT                ; if SENS_A equals 0
LT_TURN         LDAA  NEXT_D                    
                PSHA                            ; push stack
                LDAA  SEC_PTH_INT               
                STAA  NEXT_D                     
...
NO_LT_INTXN     LDAA  SENS_F                    ; if SENS_F equals 1
...
NO_SHFT_RT      LDAA  SENS_E                    ; if SENS_E equals 1
...
;--------------------------------------------------------------------------------------------
REG_PATHING     LDAA  SENS_D                    ; If SENS_D equals 1
...
NO_RT_TRN       LDAA  SENS_B                    ; If SENS_B equals 1
                BEQ   RT_LINE_S                 ; Check if SENS_A equals 1
                LDAA  SENS_A                    ; If SENS_A equals 1 a FORWARD path exists
                BEQ   LEFT_TURN                 ; The robot should continue forward
                PULA                            ; Pull the next direction value from the stack
                PULA                            ; and store it in NEXT_D
                STAA  NEXT_D                    ; ""
                BRA   NO_LINE_S                 ; Else if SENS_A equals 0
LEFT_TURN       PULA                            ; The robot should make a LEFT turn
                ...
                JMP   BK_TRK_EXIT               ; and exit
;--------------------------------------------------------------------------------------------
IRREG_PATHING   LDAA  SENS_B                    ; If SENS_B equals 1
...
NO_LT_TRN       LDAA  SENS_D                    ; If SENS_D equals 1
                BEQ   RT_LINE_S                 ; Check if SENS_A equals 1
                LDAA  SENS_A                    ; If SENS_A equals 1 a FORWARD path exists
...
RIGHT_TURN      PULA                            ; The robot should make a RIGHT turn
                ...
                JMP   BK_TRK_EXIT               ; Then exit
;--------------------------------------------------------------------------------------------
RT_LINE_S       LDAA  SENS_F                    ; Else if SENS_F equals 1
...
LT_LINE_S       LDAA  SENS_E                    ; Else if SENS_F equals 1
